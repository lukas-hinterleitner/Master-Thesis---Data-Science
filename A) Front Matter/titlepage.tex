...
\TitleThree{Project or Select? Should LLM gradients in post-training \\ instance-based explanation methods be reduced in \\ dimensionality by projecting or by selecting sub-components?}
